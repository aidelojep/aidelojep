...
- 🌱 I’m having fun with SQL(MySQL,PostGRE) NoSQL(Mongo DB,Fauna DB) Cloud Computing (AWS, Azure) Machine Learning, Artificial Intelligence and Visualization with Arctype.
